...
export default function Home() {
    ...
    const loadTeachers = async () => {
        const result = await axios.get("https://sisteducacion-4ese.onrender.com/profesores-bd");
        setTeachers(result.data);
    };

    const deleteTeachers = async (id) => {
        await axios.delete(`https://sisteducacion-4ese.onrender.com/profesorEliminado/${id}`);
        loadTeachers();
    }
